...
public class ReadHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final ListAliasesResponse listAliasesResponse =
            ListAliasesResponse.builder().aliases(aliases).build();
        doReturn(listAliasesResponse).when(aliasHelper)
            .listAliases(any(ListAliasesRequest.class), eq(proxyKmsClient));
    ...
    public void handleRequest_NotFound() {
        ...
        doReturn(listAliasesResponsePage1,
            listAliasesResponsePage2).when(aliasHelper)
            .listAliases(any(ListAliasesRequest.class), eq(proxyKmsClient));
        ...
        verify(aliasHelper)
            .listAliases(eq(Translator.listAliasesRequest(model, NEXT_MARKER)), eq(proxyKmsClient));
